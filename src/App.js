        ...
        <Router>
          ...
          <div className="container my-3" >
            <Routes>
              ...
              <Route exact path="/general" element={<News key="0" pageSize={this.pageSize} country="in" category="general" />} />          
              ...
              <Route exact path="/sports" element={<News key="4" pageSize={this.pageSize} country="in" category="sports" />} />          
              <Route exact path="/technology" element={<News key="5" pageSize={this.pageSize} country="in" category="technology" />} />          
              <Route exact path="/health" element={<News key="6" pageSize={this.pageSize} country="in" category="health" />} />          
              <Route exact path="/business" element={<News key="7" pageSize={this.pageSize} country="in" category="science" />} />         
            </Routes>
          </div>
        </Router>
      </div>
